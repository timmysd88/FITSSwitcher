...
#define MyAppName "FITSSwitcher"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Tim Dymott"
#define MyAppURL "https://github.com/timmysd88/FITSSwitcher"
#define MyAppExeName "fitsswitcher.py.exe"
...
AppId={{49A0402D-91FE-4FEC-85D5-804A89CB29B9}
AppName={#MyAppName}
...
LicenseFile=C:\FITSSwitcher\LICENSE.txt
InfoAfterFile=C:\FITSSwitcher\INFOAFTER.txt
; Uncomment the following line to run in non administrative install mode (install for current user only).
;PrivilegesRequired=lowest
OutputDir=C:\FITSSwitcher
OutputBaseFilename=mysetup
SetupIconFile=C:\FITSSwitcher\FSico.ico
...
[Files]
Source: "C:\FITSSwitcher\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
